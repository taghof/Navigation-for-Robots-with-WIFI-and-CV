...
\ref{electronic:ar2}.AR.Drone er opbygget som en letvægtskonstruktion
...
undersøgt mulighederne for at anvende AR.Dronens OTG-USB \ref{electronic:otg} port til
...
i vores blogpost "Enabling the Drone USB Port",\ref{blog_usb}. 
\begin{framefig}
  \centering
...
AR.Drone",\ref{blog:compiling}, dette var simple 'hello 
...
anvende programmet på AR.Dronen, \ref{blog:compiling}.
...
Til dette eksperiment anvendte vi bibliotekerne pyqrcode\ref{**} og Zbar
\ref{http://zbar.sourceforge.net/index.html}, til henholdsvis
indkodning og afkodning af QR-koder. Zbar har pythonbindinger og anvendes også på
Iphone-platformen. Dette betød at vi kunne teste vores genererede
