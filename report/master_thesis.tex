...
Mere konkret har specialet tre højt prioriteret mål som formuleres og
uddybes således: 
\begin{enumerate}
\item \textbf{Klientplatform:} \label{tese1} Der skal konstrueres en softwareplatform til at
  lette fjernkontrol af AR.Dronen fra PC. Den konstruerede platformen skal:
  \begin{enumerate}
  \item \textbf{Facilitere eksperimenter:} \label{tese1a} Understøtte de
    videre eksperimenter i specialet.
  \item \textbf{Tilgængelighed:} \label{tese3} Konstrueres så den
    tilgængeliggør et let anvendeligt medierende interface til AR.Dronen.
  \end{enumerate}
...
\item \textbf{Udledning af yderligere navigationsdata:} \label{tese4}
  ...
  navigationsmiljø, og om den ny viden kan bruges som støtte i den
  autonome styring af quadrokopteren. Herunder skal det konkret
  undersøges mulighederne for at bruge: 
  \begin{enumerate}
  ...
  \end{enumerate}
\item \textbf{AR.Dronen som robotplatform:} \label{tese5} Det skal
  undersøges om AR.Dronen faktisk er anvendelig som robotplatform.
\end{enumerate}
