...
%%%% Introduction - Metode
\subsubsection{Hjælpeværktøjer} % Thomas & Morten
Python ---

\paragraph{vores Platform}
selvstående afsnit om; Et værktøj udviklet til hjælp til os. Hvad kan det; hjælp til kontrolbeskeder til fjernstyring, indgang til at modtage datapakker fra AR.Dronen...
...
bevæger sig.
 Man kan udlede estimater for hastigheder ved at integrere over
...
værdierne kan være sat til 0 og AR.Dronen vil ligge horisontal, men
kan stadig godt bevæge sig sideværts i luften\footnote{AR.Dronen siges
  at være ``trimmet'' (med en konstant hastighed, evt. 0m/S) hvis den
...
denne er blevet noget mere troværdig\cite{velocity_estimation_inside_the_drone}. I dette speciale er der lavet eksperimenter
med hastighedsudledningen. Eksperimenterne er beskrevet i
afsnit~\ref{sec:distance-mesu}. Det viser sig at under de rette
forhold er hastighedsudledningen udmærket brugbar.% todo
                                % evt. målbar/udmærket? til hvilke formål?
...
% evt. +ultralydsting
%Ifølge Wikipedia.org\cite{electronic:wiki_ar.drone} skal AR.Dronen være i stand til at flyve fremad med en maksimal hastighed på $5 m/sek$ svarende til $18 km/t$.
...
\subsection{Erkendelse af miljø...}
Hvad vil vi vise, afvise teste?
Hvad kan/skal resultatet bruges til?
Hvordan løste vi det, undersøgte det, hvordan udførte vi eksperimentet?
Hvad var resultatet?
