...
Vores klientplatform kan betegnes som et system til indsamling af
AR.Dronens sensorstrømme og fjernstyring af denne. Klientplatformen
har fasciliteret de eksperimenter
...
\begin{framefig}
  ...
  \caption{En intern processklient på AR.Dronen, kommunikerer med AR.Dronen over netværket gennem UDP og TCP som ekstern klient, men har også adgang til platformen i userspace.}
