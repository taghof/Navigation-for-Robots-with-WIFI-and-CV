...
klientplatform, har vi udført en række eksperimenter,~\ref{}. Eksperimenterne
...
frontkamera (se sektion~\ref{sec:afstand}). Ved at lade AR.Dronen flyve sidelæns, trianguleres
...
for at detektere et korridormiljø, sektion~\ref{sec:korridor}. Med en sådan detektion, kan
...
modtagne hastighedsestimater. Vores eksperimenter med DistanceTrackeren
...
ikke er kendt. Vi kan dog udlede forskellige elementer, efter at
...
fra sensorerne om bord. Under arbejdet har vi kunnet konstatere, at $\theta$
...
kontrolinterfacet som en tråd der løbende sender kommandoer med de
...
kontrolinterfacet se figur~\ref{fig:ciagregateuml}. Udover at virke i platformen, kan interfacet til
til simple formål også anvendes alene, direkte fra
Pythons interpreter (som beskrevet i sektion~\ref{sec:sub:fjernstyrpy}).
...
på figur~\ref{fig:followtour}. FollowTourTask nedarver fra
...
map-objekt (se sektion~\ref{sec:mapcreator}), styr på den tour der
følges og sørger for at opdatere HoverTrackTasken med en ny 
målposition, når det er nødvendigt. 
Hvis map-objektet anskues som en relationel graf, hvor alle knuder er
...
\begin{framefig}
  ...
  \caption{Tre forskellige maarkører der er testet i forbindelse med visuel lokalisering af AR.Dronen}
  \label{fig:markers}
\end{framefig}
...
fejlagtigt antog at den genfundne første lokation var den næste i
