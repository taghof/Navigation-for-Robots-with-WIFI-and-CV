...
quadrotor\cite{electronic:wiki_quadrotor} delvis selvflyvende i et
indendørsmiljø. Mere specifikt handler det i første omgang om at
kontruere en base i software som der kan bygges videre på ved at
udnytte en AR.Drones\cite{electronic:ardrone} indbyggede sensorapparat
...
%-problem domæne,
Præmissen for specialet har under foløbet ofte rykket sig, men er hele
tiden flyttet tilbage til ``at der skal være et underholdende
indhold''. Underholdningfaktoren skinner også tydeligt igennem hvis
man kigger på hjemmesiden for Parrots AR.Drone
\begin{figure}[ht]
  \centering
...
brugerens iPhone eller iPad%\cite{electronic:ardrone}. 
Det har siden fundet stor anvendelse, ikke blot som et avanceret
stykke legetøj. 
...
<- underholdning minerva museumsrobot
...
Forskningen i quadrotere er gået fra at forstå og optimere mekanikkens / den fysiske interaktion/påvirkning med luften - bygge gode kontruktioner\cite{quteprints33767} refererer til 
...
forskellige frameworks til sensordata opsamling og udledning/abstraktioner
...
\paragraph{Anvendelser}%eller under motivation...
Sousveillance vs. surveillance, noget multimedieæstetik, 
occupy movement thing http://www.alternet.org/occupywallst/153542/ows\_fights\_back\_against\_police\_surveillance\_by\_launching\_\%22occucopter\%22\_citizen\_drone/
...
\paragraph{Anvendelser}%anvendelser fra dette speciales emner
Minerva museums tourguide robot\cite{Thrun99minerva:a}
...
lokationer(WIFI, farvebeskrivelse og koordinater) og en
...
anvendt en FollowTourTask\ref{sssec:followtourtask}, denne anvender førnævnte kort til at bevæge
sig mellem lokationerne i kortets rutebeskrivelse. 
...
Vores første forsøg med visuel lokalisering anvendte simple røde
markører i A5 størrelse. Fire af disse markører blev placeret på
gulvet jævnfør det på kortet beskrevne mønster\ref{fig:kort}. 
Vores første forsøg viste os, at vi i højder fra 0.5 til 2.5 meter altid var i stand
til at genkende disse markører med AR.Dronens bundkamera. 
Vi havde til formålet implementeret en blobdetectionalgoritme i Python, som for
...
forbindelse med afviklingen af en HoverTrackTask~\ref{sec:hovertrack}
for at få en idé om metodens anvendelighed i en
realtidskontekst. Forsøget afvikledes ved at AR.Dronen blev fløjet i 
position over en markør, hvorefter HoverTrackTasken blev
aktiveret. Her viste det sig tydeligt at pythonblobdetectoren ikke var
effektiv nok, vi var ikke i stand til at opdatere hurtigt nok og som
resultat nåede AR.Dronen ofte at bevæge sig væk fra markøren. Dette
resultat fik os til at reimplementere HoverTrackTasken således at den
anvendte vores blobdetector til at opdage markøren og herefter
anvendte OpenCVs opticalflow-algoritme(optflowpyrlk) til at
tracke den. Afviklingen af opticalflow-algoritmen er omtrent 10 gange
hurtigere end vores blobdetector. Da vi gentog forsøget med denne
...
error-værdierne i x og y-retningen over en periode på mere end 2
minutter hvor AR.Dronen befinder sig over en markør, det bemærkes at
der er et udsving omtrent midt i forløbet, dette er ikke usædvanligt,
da AR.Dronen er meget påvirkelig af turbulens og dette let forekommer
i, især, mindre lokaler.
\begin{figure}[ht]
  \centering
...
der fulgte en rute mellem de fire markører. Eksperimenterne startede
...
fandt vi to andre problemer. Det første problem var relateret til at
...
grund til tanken om at anvende mere avancerede lokationsmarkører. Det andet problem
...
blev nået hvorefter experimentet alligevel måtte afsluttes.   

De overordnede resultater af vores eksperimenter med de simple
lokationsmarkører var, vi fik bekræftet AR.Dronens evne til at
