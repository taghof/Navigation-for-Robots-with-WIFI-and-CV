...
i en af specialets tilhørende blogpost: "Enabling the Drone USB Port",\cite{blog:usb}. 
\begin{framefig}
  \centering
...
Efter de første erfaringer med AR.Dronens USB-port, blev det valgt at
...
og et snifferprogram til at aflæse og videresende signalstyrkerne fra de
...
omkringliggende kilder. Netværksinterfacet mode opsættes
gennem et script (*ref til annoteret startup*) som kaldes til sidst i AR.Dronens
