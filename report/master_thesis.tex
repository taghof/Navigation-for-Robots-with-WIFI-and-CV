...
Figurene~\ref{fig:houghprocessen}%fig:vanishopa} til \ref{fig:vanishopd} illustrerer forskellige trin i
...
flyvning. Konceptet er kendes som en triptæller i biler og som en
tacho-counter i motoren på nogle kørende robotter.  

Indenfor robotnavigation anvendes ofte en teknik kaldet
dead reckoning, \cite{wiki:deadreck}. Dead reckoning betyder, at den nuværende
position udregnes på baggrund af en tidligere positionsudregning og viden om
retning og hastighed. En mulig anvendelse af DistanceTrackeren kan
således være, som en del af en sådan dead reckoning algoritme. En
forudsætning for en præcis dead reckoning er dog, at den udledte
afstand er præcis. Dette undersøges herunder.

DistanceTrackeren fungerer ved at integrere over de
hastighedsestimater, der modtages i AR.Dronens navdatastrøm. Disse
...
flyvninger mellem de to markører: Manuel flyvning med ensartet underlag, automatisk flyvning
med ensartet overflade og automatisk flyvning uensartet overflade. Hver
type flyvning blev gentaget 10 gange. Generelt foregik de manuelle
flyvninger hurtigere end de automatiserede (de automatiserede
flyvninger blev udført ved hjælp af en FollowTourTask). Resultaterne af
flyvningerne kan ses på figur~\ref{fig:xdistr} og
figur~\ref{fig:ydistr}, som viser henholdsvis de målte afstande i
x-aksens retning(flyveretningen) og i y-aksens retning.
...
\begin{framefig}
  ...
  \caption{Kumulativ distribution af målte afstande. Målingerne
    ...
    fløjet fremad og ikke til siderne.} 
  \label{fig:ydistr}
\end{framefig}
