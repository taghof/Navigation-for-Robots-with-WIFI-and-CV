...
i \uri{/bin/program.elf} på AR.Dronen. Da der er tale om proprietært software
...
linuxkerne, samt at omgå AR.Dronens software for ikke at miste
strømmen til USB-porten, \cite{blog:usb}. Det indledende
proof-of-concept var, at få mounted en almindelig USB-memorystick, at
skrive til og at læse fra den. Indstallationsproceduren er forholdsvis
...
accelerometer og gyroer \emph{præcis} hvor
langt AR.Dronen har fløjet eller med \emph{præcis} hvilken hastighed AR.Dronen
...
med et forholdsvist lille overhead. Det gør, at der i
...
./testdata/map.data. I map klassens
