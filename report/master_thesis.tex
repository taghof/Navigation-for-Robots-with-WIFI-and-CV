...
\begin{framefig}
  ...
  \caption{Opstillingen er set oppefra. AR.Dronen har flyttet sig fra
    ...
    $\Delta t$. Den grønne cirkel (feature2track (f2t)) er et punkt i billedet, oprindeligt fundet ved
...
returnes af funktionen \emph{goodFeaturesToTrack}. Hver gang
funktionen kaldes, opdateres værdierne i listen med nye
$(x_i,y_i)$-positioner.

Af en features $x$-position i et billede kan man udregne vinklen i den
virkelige verden i forhold til den retning AR.Dronens frontkamera peger.
\begin{framefig}
  \centering
  \includegraphics[width=0.35\textwidth]{grafik/f2t.png}
  \caption{Udregning af en features ($f2t_i$) vinkel i forhold til AR.Dronens
    ligeud-retning. Vinklen beregnes udfra $x$-værdien af $f2t_i$' pixelposition.}
  \label{fig:f2kvinkel}
\end{framefig}
...
flyvning. Tanken er at navdataens yaw-værdi alligevel er stabil nok
...
\begin{framefig}
  ...
  \caption{Den beregnede afstand ud til et fast punkt på væggen i en filmsekvens over
    ...
    $x$-aksen er millimeter, mens $y$-aksen er billedramme nummeret.}
...
ikke virker sådan som opsætningen er nu, er fordi vinklen i trekanten bliver
for spids. Liniestykket imellem $p1$ og $p2$ er for kort. Det er meget
begrænset hvor langt AR.Dronen kan nå at flyve mellem 2
billedopdateringer. Selv hvis der kun 10 billeder per sekund så vil
$\Delta t$ være lig $0,1$ sekunder. Hvis AR.Dronen bevæger sig med en
hastigheden af eksempelvis $100$ milliimeter per sekund, så er
afstanden mellem de to punkter $100 mm/s * 0,1 s = 10 mm$. Hvis de 2
andre sidelængder så er en faktor 500 gange større, er det nemt at se
