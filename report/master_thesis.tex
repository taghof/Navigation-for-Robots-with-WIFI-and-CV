...
FollowTourTask (sektion~\ref{sssec:followtourtask}). Generelt blev de
...
markør-detektoren (se sektion~\ref{ssec:avancemarkoer}), der er en del af FollowTourTask.
...
afstanden i fremadrettet flyveretning sådan som AR.Dronen og
DistanceTraker har målt dem, mens figur~\ref{fig:ydistr} viser
