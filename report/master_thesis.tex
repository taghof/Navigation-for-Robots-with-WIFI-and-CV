...
%DEF: Unmanned Arial Vehicle (UAV)
Quadrokopter

\paragraph{Omkring AR.Dronen}
%  + Parrot er producent}
%AR.Drone, \cite{electronic:ardrone} 
%(se figur~\ref{fig:devisen}).
\begin{framefig}
  \centering
  \includegraphics[width=0.50\textwidth]{grafik/flyingvideogame.png}
  \caption{AR.Dronens logo med slagordene \emph{the Flying Video Game} figuren er klippet ud fra \cite{devisen}.}
  \label{fig:devisen}
\end{framefig}
...
Underholdningsfaktor: -> -> ->
 udover enabling technologies så også båret af masseforbrugere gadgets som,
specielt indenfor ``gadget''-genren. Kendte eksempler herpå er robotstøvsugeren
...
%båret af løfte om støtte menneskers arbejde og dagligdag
I artiklen, \cite{electronic:redningsdronedk} refereres til
en næste version af en redningsdronen som afhjælpe kystvagter ved selv at flyve ud til den
nødstedte og aflevere en redningsvest. 

Inspektionen af højspændingsledninger og broer, \cite{uavbridgeinspection2007}
bruges som støtte

%
%\ ... {Related works} hobby selvbyg (ombygge fysisk LED/GPS/WIFI) /
%flashe ny styreprogram ombord \paragraph{Lignende arbejde -
%forskning} %\cite evt. flere som har brugt AR.Dronen i deres forsøg
%\cite{electronic:ludep}\cite{single_img_pespective_cues} forskning,
%bl.a. LUDEP. --- UD_DYB hvad det er referencerne har lavet 
...
*billede af ``photoshop'' ar.drone flyvende i l'Louvre*g
...
platform fra bunden, som i \cite{quteprints33767}. Til dette projekt,
har dette dog ikke været en praktisk mulighed.
