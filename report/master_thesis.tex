...
%%   \caption{AR.Dronens logo med slagordene \emph{the Flying Video Game}
%%     figuren er taget fra \cite{devisen}.}
%%   \label{fig:devisen}
%% \end{framefig}
...
\todo{*billede af ``photoshop'' AR.Drone flyvende i l'Louvre*}
...
AR.Dronens store udbredelse vil sikre et aktivt udviklermiljø, som
både kan fungere som hjælp og inspiration under udviklingen af
projekter med AR.Dronen.
%
til prisen er ar.droen ok, men virker måske ikke så godt til indendørs
/ præcision / turbulens ift lokationskrav, men så et andet
brugsscenarie, noget turist-happening som flyv en tur på stævnsklint
for 100 kroner, se andres optagede videoer *billede*, reference til
fårehyrde-robot?
%
eksempel argumentation på hvorfor AR.Dronen ikke virker som
videnskabelig platform, for stor og klumpet, ny forskning i
quadrokopter viser det også, eg. swarms med mikrokopter
\cite{turpin:swarm}.
