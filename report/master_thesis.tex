...
frontkamera \todo{hvorfor to ** efter fronkamera morten?}. Dette giver
...
på drop-down listen yderst til venstre i den røde firkant på
...
trække en linie med musen fra CompoundTasken til den ønskede
subtask. Hvis brugeren ønsker afkoble en subtask fra en CompoundTask,
...
disse afvikles, og dermed udføres af AR.Dronen, ved at markere den
...
\begin{framefig}
  ...
  \subfigure[Et billede af en gang påført gauss-sløring]{
    \includegraphics[width=0.22\textwidth]{grafik/vanish_operation_a.png}
    \label{fig:vanishopa}}
  ~ %add desired spacing between images, e. g. ~, \quad, \qquad etc. (or a blank line to force the subfig onto a new line)
  \subfigure[Billede a efter kantdetektering (her et sobel-filter)]{
    \includegraphics[width=0.22\textwidth]{grafik/vanish_operation_b.png}
    \label{fig:vanishopb}}
  ~ 
  \subfigure[Hough-linier, udregnes udfra kantpunkterne i billede b]{
    \includegraphics[width=0.22\textwidth]{grafik/vanish_operation_c.png}
    \label{fig:vanishopc}}
  ~ 
  \subfigure[Vandrette og lodrette hough-linier sorteres fra billede c]{
    \includegraphics[width=0.22\textwidth]{grafik/vanish_operation_d.png}
    \label{fig:vanishopd}}
  ~ 
...
gennem grænseværdierne gør at problemet der søges løst kan neddeles
...
\begin{framefig}
  \centering
  \includegraphics[width=0.99\textwidth]{grafik/out_put_2jpg.png}
  \caption{Billedet er opdelt i $11 \times 11$ celler. I hver celle
    gemmes antallet af linier som skære hinanden. I dette tilfælde er
...
\subsection{troværdighed / trustworthyness}
observationer har vist at, antallet af skæringspunter skal være over 85, og der skal være 

simplificeret løsning der virker, anden tilgang end
\cite{single_img_pespective_cues} hvor der bruges mere
resourcekrævende bayesian post pre knowledge / viterby-algoritme.

? udledningen af højere abstraktionslag virtuel sensor
Dey01 et al., \cite{Dey01:ctoolkit} context-widget
sammenlign med anden viden - hastigheden $v_x$ og $v_y$ 
- Hastigheden er udledt af 

? senere at implementere det som en virtuel sensor som i sektion~\ref{sec:sub:virtuel}.



%implementation !how did we solve it!
introtext



\subsection{At finde kanter i et billede}
Vi valgte canny fordi kantmarkeringerne af et Sobelfilter er bredere end
med Canny. simpel forklaring med kantdetektering nøjes med 1 dimension.
\begin{framefig}
  \centering
  ...
  \caption{Graf over rød-, grøn-, blå-farveværdier for en linie i
    ...
    $j$. Der hvor grafen for intensiteten har stejlest hældning er der stor sandsynlighed for en
    kant i billedet.}
  \label{fig:kanter1}
\end{framefig}
...
billedet. Udglatningsoperationen udføres med et gaussisk
 udglatningsfilter, \cite{electronic:wiki_gaussklokke}, (fra
...
af gradienten og finder maximum ved den anden afledtes skærring med 0.
