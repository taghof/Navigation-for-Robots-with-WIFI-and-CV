...
istedet for behaviors, som ellers både bruges i artiklen 'A Modular Hierarchical Behavior-Based Architecture',
...
og behandlede data fra AR.Dronens sensorer, for herefter at stille
disse data tilrådighed for andre tasks, gennem en delt kontekstliste. I
...
starter deres subtasks en efter en, men venter med at starte en ny
...
starter alle deres subtasks på en gang og stopper også når den
...
På ~\ref{fig:taskhieraky} ses et eksempel på et tasktræ
konstrueret med vores taskcreator. Under antagelse af at hver TestTask
...
behaviors kan beregnes og herefter aktiveres.
...
Hvis man anskuer vores map-objekt som en relationel graph hvor alle knuder er
...
den sendes videre. Det ville desuden være let at lade vores
*DistanceMeasurer* algoritme tilføje metrisk data til map-objektet, hver gang
...
virtualsensors.py, \cite{github:virtual} og WIFI-mappet er
