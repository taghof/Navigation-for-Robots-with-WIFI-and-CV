...
under en initiel offline-fase. Herefter kan livesignalstyrkemålinger
...
WIFI-infrastruktur i testmiljøet i Zuse-bygningen på Daimi.
...
implementation udemærket. Testen gav et indtryk af at den foreslåede
ide var brugbar nok til at afterfølge.
...
problem var relaterede til, at de anvendte markører var ens. Dette betød, at der var
tilfælde hvor AR.Dronen fandt samme lokation to gange i træk, og 
antog fejlagtigt at den genfundne første lokation var den næste i
...
FollowTourTasken meget mere robust.
...
udføre thresholding ved hjælp af OpenCVs \code{inRange} algoritme. Dette
...
billede. Dette gøres med OpenCVs \code{findContours} algoritme. Tredje
skridt indbefatter at udvælge de konturer der har et stort nok areal
til at være interessante. Dette gøres med OpenCVs \code{contourArea}
...
anvender igen OpenCVs \code{inRange} algoritme. Hvis en sådan farvet
blob findes, kan farven sammenlignes med beskrivelsen af de forskellige
...
udlede orienteringen af AR.Dronens front. Dette vil gøre FollowTourTasken mindre
afhængig af de upræcise $\psi$-målinger fra AR.Dronens piezo-sensor (se sektion~\ref{ssec:dronerecap}). 
...
sensor her løbende skifter mellem de to kamerastrømme. Det blev undersøgt om
...
navigeres mellem de fire punkter med FollowTourTask. Opstillingen kan
...
indkodning og afkodning af QR-koder. Zbar er det bibliotek der også
bruges i iPhone-app'en til afkodning af QR-koder. Zbar har
pythonbindinger så det kan bruges på billeder taget med AR.Dronen.
Der blev genereret en QR-kode som i figur~\ref{fig:qr_woah}, og koden
blev testet til at kunne afkodes korrekt med en iPhone, inden
aftestning med AR.Dronen.
\begin{framefig}
  \centering
...
så virker AR.Dronen til prisen som værende god-nok. Erfaringen med
AR.Dronen gennem projektet er, at den måske ikke virker helt så godt 
