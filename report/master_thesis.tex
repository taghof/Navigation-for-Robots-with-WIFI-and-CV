...
%
Specifically a software platform is implementet, that makes data
from the built-in sensor device on the AR.Drone available and is
responsable for maintaining the control connection to the AR.Drone. 
%
...
performed experiments are regarding:  
%
How can the sensor apparatus aboard the AR.Dronen be exploited to
derive more abstract information about AR.Drones immediate
environment (as in information not already accessible).
%
How the derived information can be used by the AR.Dronen to navigate by
...
solutions to infer information about the local area AR.Dronens.
}
\end{otherlanguage}
\abstract{
...
besvarelsen af en række spørgsmål gennem eksperimentation.
%
...
der anvender det offentliggjorte interface. Til gengæld er der ingen
indflydelse på det styreprogram der kører på AR.Dronen og AR.Dronen kan kun
styres AR.Dronen gennem interfacet. Det er muligt at implementere et
...
\subsection{Python}
Klientplatformen implementeres i Python. Grunden til dette er primært Pythons læsbarhed og simple
...
eksperimenter,~\ref{chap:Eksperimenter}. Eksperimenterne omhandler
...
\paragraph{DistanceTracker:} En del af den navigationsdata der modtages
...
afstandssensor. Denne opererer ved at udsende en ultralydspuls og
herefter måle tidsintervallet der går før ekkoet
måles. Ultralydsmåleren er angivet til at virke op til 6 meter og er
fysisk placeret på navboardet, på AR.Dronens underside (se figur
\ref{fig:navboard}).
...
kan foregå i løbet af 90 minutter og et fuldt opladt batteri giver
...
IP\cite{rfc791}-adresser og lave et netværk mellem en ekstern klient
...
\item og en algoritme til at detektere tags i billeder, til brug for
