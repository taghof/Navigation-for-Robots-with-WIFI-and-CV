...
\subsection{Fysik}
\label{ssec:fysik}
AR.Dronen har 4 rotorvinger eller propeller siddende i hver sit hjørne af et kulfiberkryds
på dronen. Propellerne er gearet ned i omdrejninger i forhold til motorene der trækker dem.
2 rotore drejer den ene vej (med uret), mens et andet par motorer og rotorer drejer den anden vej (imod uret)\cite{ardroneDevGuide}.

Dronens flyvning og bevægelser i rummet kan beskrives med 3 bevægelsesakser (x, 
y og z), det vil giver god mening idet man så kan referere til accelerometer og gyro ombord på dronen.
Alle dronens bevægelser styres ved at kontrolere dronens vinkel i forhold til de 3 akser, eg. skal dronen
flyve fremad roteres dronen så den hælder fremad, dvs. forenden
kommer lidt under bagenden ift afstanden til gulvet se figur \ref{fig:drone_movements}c. 
Bruges termerne i figur \ref{fig:drone_movements} så laver vi en så roteres dronen en smule om y-aksen (pitch).
...
stand til at flyve fremad med en maksimal hastighed på 5 m/sek svarende til 18 km/t. %\cite{wikiDrone}
\begin{figure}[ht]
  \centering
...
\end{figure}
Vinkelhastigheden har selvfølgelig indflydelse på den løftekraft propellerne påvirker dronen med hver især. 
Kraften ($F$) er som bekendt et resultat af en accelerations ($a$) påvirkning af en masse ($m$), ie. $F = a \cdot m$. %\times
For at dronen kan ``hover'', altså at stå stille i luften, skal der tilføres en trimkraft\footnote{Når helikopteren er ``trimmet'' betyder det at der ikke er ændringer i hastigheden, dvs. ingen acceleration.} hvis resultat er ingen hastighed i alle retninger, men at der stadig er en samlet løftekraft ($\ddot{Z}$) der modsvarer tyngdeaccelerationens påvirkning præcist. 

Figur \ref{fig:drone_movements}a er en illustration af hvad der skal til for at flytte dronen vertikalt. 
Vinkelhastighed på alle 4 propeller ændres fra $\Omega_H$ til $\Omega_H + \Delta_A$. 

Øges eller sænkes vinkelhastigheden ens på hver af propellerne vil det resultere i en ændring af den samlede tilførte kraft, hvilket igen er ensbetydende med en forøgelse eller aftagelse i den samlede acceleration. En accelerationen eller deceleration kan bibeholdes indtil dronen har opnået en ønsket bevægelses hastighed. 

%http://www.rcgroups.com/forums/showthread.php?t=1284741&page=5
...
balancere et kosteskaft på fingeren, positionen skal reguleres aktivt ellers ``drifter'' den ud
\pagebreak
