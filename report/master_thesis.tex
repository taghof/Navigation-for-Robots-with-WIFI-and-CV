...
delskridt (se figur~\ref{fig:korridorvandfald}). Inputbilledet roteres
...
hver af de diagonale linier beregnes. Antallet af linieskæringer
tælles op for hver celle i billedet (der er $11 \times 11$ celler per
billede, se figur~\ref{fig:phiaugmentet}).  Afhængig af om der er en
korridor eller ikke, er det som sagt oftest ved cellen med størst
antal linieskæringer at forsvindingspunktet kan findes.
%
