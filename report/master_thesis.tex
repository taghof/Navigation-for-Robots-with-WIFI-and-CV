...
klientplatformen. Blandt andet at give brugeren adgang til en grafisk
...
i~\cite{}. Bloggen indeholder udover en projektbeskrivelse, især informationer om vores tidlige
...
bearbejder kontinuerligt billeddata for at genkende henholdsvis
...
hurtige kameraskift ved hjælp af software og at der derfor er stor
...
I platformen anvendes Joystick istedet for en iPhone eller iPad til at
...
disse til fjernstyrings-interfacet (ControllerInterface). Xbox360
Joystick-controlleren bruges udover manuel fjernstyring af AR.Dronen
også til at starte forprogrammerede handlingssekvenser, ie. tasks
(task beskrives nærmere i sektion~\ref{sec:tasks})).  Således kan
piloten manuelt bringe AR.Dronen i en ønsket position og så herefter
starte den automatiske afvikling af et forudbestemt bevægemønster.  På
...
receiverne. Taskmanagerens opgave er at starte
forudspecificerede opgaver (tasks som gennemgåes i
...
den virtuelle sensorer. Tasks skal således ikke behandle sensordata, men kun
reagere og formidle bevægelse på baggrund af højniveau-sensordata.
...
subtasks en efter en og venter med at starte en ny subtask, før den
...
fastholdelse af en erkendt position, HoverTrackTasken beskrives i
sektion~\ref{sssec:hovertracktask}). Selve FollowTourTask 
...
PID-controller, til at bestemme de endelige værdier der sendes til kontrolinterfacet
, for at bevæge AR.Dronen. PID-funktionaliteten er implementeret i HoverTrackTaskens
...
frontkamera. Den forholdsvis simple task udnytter AR.Dronens muligheder,
for at bevæge sig i rummet. Grunden til at AR.Dronen bevæges op og
...
subbehaviors der skal aktiveres. I artiklen er dette er praktisk, da
...
egnede subtask, da vi ikke opererer ikke med flere aktive tasks
...
\chapter{Klientværktøjer} % Morten, I dette kapitel gennemgåes tre
\label{chap:clienttools}
værktøjer som er udviklet i forbindelse med specialearbejdet. Der er
...
anvendes af vores FollowTourTask(Mapcreator) og et program til at
...
punkter fra map-objektet. Meningen med punkterne er, at de skal matche en
