...
~\ref{fig:detection}, sammen med resultaterne for de andre markører.
...
mere avanceret form for markører. Vores første redesign var markøren der
...
Resultaterne kan ses på figur \ref{fig:detection}
...
godt. Vi har derfor undersøgt mulighederne for at anvende det
kamerafeed hvor bundkameraets billeder er lagt oven på
...
markører. Resultaterne ses på figur \ref{fig:detection}, de viser tydeligt at
...
\begin{figure}[H]
  ...
  \caption{Detektionsrater for de forskellige markører i højder op til
    2.0 meter, desuden detektionsrater for de forskellige markører ved
    88x72 billeder}
  \label{fig:detection}
\end{figure}
