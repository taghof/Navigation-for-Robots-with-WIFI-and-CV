...
\subsection{Fysik}
\label{ssec:fysik}
Dronen har 4 rotorvinger eller propeller siddende i hver sit hjørne af et kulfiberkryds
...
Kraften ($F$) er som bekendt et resultat af en accelerations ($a$) påvirkning af en masse ($m$), ie. $F = a \times m$. 
For at dronen kan ``hover'', altså at stå stille i luften, skal der tilføres en trimkraft\footnote{Når helikopteren er ``trimmet'' betyder det at der ikke er ændringer i hastigheden, dvs. ingen acceleration.} hvis resultat er ingen hastighed i alle retninger, men at der stadig er en samlet løftekraft ($\ddot{Z}$) der modsvarer tyngdekraften ($g$) præcist. 
