...
reckoning,~\cite{wiki:deadreck}. Dead reckoning betyder, at den
...
reckoning er dog, at den udledte afstand er troværdig. Præcisionen
undersøges herunder.
...
med ensartet underlag og automatisk flyvning uensartet underlag (gode
...
FollowTourTask\todo{ref}. Generelt blev de manuelt styrede flyvninger gennemført med højere
hastighed end de automatiserede, mens de automatiserede flyvninger i
reglen tog længere tid at færdiggøre. Den længere udførselstid kommer
af at odometri-afstandsmåleren skulle testes at virke sammen med
markør-detektoren (\ref{}), der er en del af FollowTourTask.
