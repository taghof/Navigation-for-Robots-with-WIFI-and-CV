...
\item \textbf{Konstruktion af klientplatform:} \label{tese1} Der skal konstrueres en softwareplatform til at
  ...
  \item \textbf{Være let anvendelig:} \label{tese3} Konstrueres så den
...
\item \textbf{Udledning af yderligere navigationsdata:} \label{tese4}
  ...
  navigationsmiljøet, og om den ny viden kan bruges som støtte i den
  semi-autonome styring af quadrokopteren. Herunder undersøges konkret
...
bygge en quadrokopter-platform fra bunden. De indbyggede sensorer har
dog på nogen punkter begrænset udviklingsmulighederne, %hvor?
...
orientering besværliggøres på grund af sensordrift (præcis disse problemer er dog
udbedret i %også qr?
