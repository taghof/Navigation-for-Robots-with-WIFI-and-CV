...
\begin{figure*}[htp]
  ...
  \subfigure[USB-kabel og de enheder vi har haft tilslutttet AR.Dronen.]{
    \includegraphics[width=0.4\textwidth]{grafik/usbdevices.png}
    \label{fig:cableandusbdevices}}
  ~ %add desired spacing between images, e. g. ~, \quad, \qquad etc. (or a blank line to force the subfig onto a new line)
  \subfigure[AR.Dronen med usbstick tilsluttet.]{\includegraphics[width=0.4\textwidth]{grafik/usbattached.png}
...
afkodningshastigheden og desuden eliminere vores afhængighed af Psyco Python til at speede denne
afkodning op.
...
en signalstyrke. Wifireceiveren modtager en pakke for hver pakke
