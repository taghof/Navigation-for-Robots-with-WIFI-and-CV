...
\item \textbf{Konstruktion af klientplatform:} \label{tese1} Der skal konstrueres en softwareplatform til at
  ...
  \item \textbf{Tilgængeliggøre AR.Drone interface:} \label{tese3} Konstrueres så den
...
\todo{men også ... pdf-udgaven af specialet, videoer af...}
...
\begin{framefig}
  \centering
  \includegraphics[width=0.8\textwidth]{grafik/vanishresultgraf.png}
