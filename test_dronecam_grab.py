...
drone.start()
# ci = self.drone.getcontrollers.ControllerInterface()
# ci.start()
...
video_sensor = drone.get_video_sensor()#receivers.VideoReceiver()
#video_sensor.start()
navdata_sensor = drone.get_navdata_sensor()#receivers.NavdataReceiver()
#navdata_sensor.start()
ci = drone.get_interface()#controllers.ControllerInterface()
#ci.start()
