...
som nævnt er tilstrækkelig i de fleste tilfælde, men, som det fremgår afafsnit~\ref{sec:QRdecoding}, er billedkvaliteten ikke tilstrækkelig
...
AR.Dronen. Herunder vises simple eksempler på anvendelsen af dele af
klientplatformen.  
...
process der nævnes i sektion 7.2 side 43 i
...
platformen, kan interfacet til til simple formål også anvendes alene,
