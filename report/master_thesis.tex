...
Python sproget blev i første omgang valgt for lette tilgængeligheden for
brugeren. Et af målene med specialet er, at stille en let anvendelig og
...
I dette kapitel gennemgåes de tre værktøjer vi har udviklet i
...
et program til at bygge de kort der anvendes af vores FollowTourTask(Mapcreator)
og et program til at instantiere, kombinere og afvikle Tasks(Taskcreator).
...
Sensordisplay-programmet er implementeret i
...
Når navdatastrømmen er aktiv præsenteres brugeren for et billede som
det på figur~\ref{fig:navdatadisplay}. På dette billede findes
oplysninger såsom højde, hastighed, samt vinklerne $\theta$, $\phi$ og
...
Når videostrømmen er aktiv vises et billede som det på
figur~\ref{fig:videodisplay}. Afhængig af hvilken videostrøm der
modtages eller om der løbende skiftes videostrøm, vil en af billedrammerne
der vises muligvis være sort. Hvis der løbende skiftes videostrøm,
vises det nyeste billede fra hver videostrøm i de to billedrammer.

Hvis WIFI-sensorprogrammet(beskrevet i sektion~\ref{sec:sub:sub:wifisensor}), er startet på AR.Dronen og
brugeren har valgt at vise WIFI-strømmen, vil brugeren blive
...
$ ./sensordisplay.py -t
\end{verbatim}
\caption{Afvikling af sensordisplay programmet fra en linuxkommandolinie.}
...
\begin{framefig}
  \centering
  \subfigure[World editor]{\includegraphics[width=0.47\textwidth]{grafik/mapworld.png}
    \label{fig:mapworld}}
  ~ %add desired spacing between images, e. g. ~, \quad, \qquad etc. (or a blank line to force the subfig onto a new line)
  \subfigure[Tour editor]{\includegraphics[width=0.47\textwidth]{grafik/maptour.png}
    \label{fig:maptour}}
...
visuel markør i den fysiske opstilling, som på
...
WIFI-signalstyrkemålinger(fingerprint) til punkterne ved at trykke på
...
ved at holde 'ctrl' nede og så trække en linie med musen mellem to punkter. Det
er kun muligt at forbinde til enten det første eller sidste punkt i en
...
$ ./mapcreator.py -t
\end{verbatim}
\caption{Afvikling af mapcreator programmet fra en linuxkommandolinie.}
...
\begin{framefig}
  \centering
  \includegraphics[width=0.90\textwidth]{grafik/taskcreator.png}
  \caption{derpa}
...
\
Lidt omkring hvordan man kan detektere at man er i en lang korridor. Plus nogle referencer til andre hvorfra der er kommet inspiration.
