...
firma Parrot \cite{electronic:parrot, electronic:wiki_parrot}.
...
ovenpå\cite{electronic:ludep, single_img_pespective_cues} og som platform til selv at
...
, samt et accelerometer. I 2012 ventes en opdateret udgave af AR\.Dronen. Den nye version tilføjer yderligere et kamera i høj opløsning (HD),
...
får brugeren her adgang til en root-terminal. %telnet?
...
AR.Dronen. Nogle af de mest markante / relevante observationer er
listet herunder.
...
Selvom det synes at give mening at beskrive AR.Dronens bevægelser i 3
dimensioner og deri nemmere at bruge accelerometer- og gyro-målinger
fra sensorene om bord. Så kan man egentlig ikke sige noget udfra
...
aflæses af accelerometeret. Afstande AR.Dronen har flyttet sig kan
således heller ikke aflæses af accelerometer og gyro alene.
 Dog har Parrot underbygget hastighedsestimatet med en optical-flow
...
forhold er hastighedsudledningen udmærket brugbar. U-rette forhold er
hvis det ikke er muligt for bundkameraet at opfange tilpas mange
tydelige kendetegn i gulvet, vil hastighedudledningen være
fejlbehæftet.
%
...
\end{figure}
Højdemåleren består som sagt en ultralyds sender og modtager, teknologien gør at 
 højden ikke er udfra et specifikt punkt, men derimod returnerer den
 mindste højde indenfor et område som det på figur
 \ref{fig:sonicbeam2}. Dvs. højden er udledt af den tid der går fra en
...
%
De nævnte problematikker kan have indflydelse ved udvikling med AR.Dronen. Bl.a. andet er det en god ide at have det sig for øje når quadrokopteren hælder meget, ie. ved flyvning i høj hastighed.
%
\paragraph{Realtidssystem} En kilde, hvor det desværre ikke har været muligt at genfinde referencen, menes at have sagt at det operativsystem, styreprogram og de eksterne processer der kører på AR.Dronen tilsammen bruger op mod $80\%$ af CPU-tiden. -- Om det akurat er $80\%$ eller en anden sats vil have indvirkning hvis man vælger at afvikle yderligere processer på AR.Dronen, eg. USB-understøttelse under flyvning og Wifi-signalstyrke indsamling som beskrevet i afsnit~\ref{ssec:wikilokalisering}. Pointen er at man ikke kan bruge mere end de resterende f.eks. $20\%$ uden at det vil gå ud over kontrollen med flyvningen.
%
\paragraph{Trådløs båndbredde} Der er ikke et stort overhead i User datagram protokollen pga. transmisionskontrol. Det gør at der i princippet kan sendes flere f.eks. videopakker end med en synkroniseret kommunikationsprotokol som TCP. Oveni at der kontinuerligt sendes friske datapakker så giver det mest mening at anvende en asynkron protokol i realtidskommunikationen med quadrokopteren idet det ikke kan betale sig at bruge resourcer på at generhverve det fåtal af billedframes der går tabt pga. fejl i transmissionen, det er bedre at indlæse den næste datapakke istedet. Information i den gamle datapakke vil alligevel være forældet og urelevant.
%
\paragraph{Billedkvalitet} AR.Drone er et produkt der er designet til mainstream og masserne. Kravende har været at den skulle være relativ billig i produktion og dermed let kunne erhverves af menigmand. I dette valg af design har Parrot lavet et afvejet valg i et tradeoff mellem kvalitet af billeder versus antal af billeder der bliver afsendt per sekund. Det betyder at opdateringshastigheden af billeder og data fra AR.Dronen er tilstrækkelig i de fleste tilfælde, men, som det fremgår af afsnit~\ref{sec:QRdecoding}, at til en simpel ting som afkodning af QR-koder (hvortil der findes færdige værktøjer) er billedkvaliteten ikke af tilstrækkelig kvalitet.
%
...
Det er ikke praktisk idet det nedsætter
opdateringshastigheden. ydermere er der et lille delay forbundet med
