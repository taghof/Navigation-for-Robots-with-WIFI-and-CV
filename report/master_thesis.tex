...
\section{Konstruktion af klientplatform} 
Klientplatformen har været det primære arbejdsredskab under ekperimenterne med
AR.Dronen. På trods af kontinuerlig udvikling under hele projektet,
...
\section{Semi-autonom navigation}
...
Udledning af yderligere navigationsdata fra AR.Dronenssensorstrømme
har været hovedtemaet i de udførte eksperimenter. En stor del af de
udførte eksperimenter har omhandlet lokalisering. Under denne process
er der udviklet en visuel markør, figur~\ref{fig:markers}, som
konsistent kan genkendes med AR.Dronens bundkamera. Markøren og
FollowTourTasken, som er udviklet sideløbende, muliggør AR.Dronens
navigation efter en planlagt rute.

Efter eksperimenter der undersøgte anvendelsen af WIFI-fingerprinting
til lokalisering, blev denne teknik fundet for
upræcis,~\ref{ssec:wifilokalisering}. Der er teknikker til at forbedre
resultaterne, men teknikken er meget følsom og kræver et større
eksperiment-setup end vi har haft mulighed for. Det forudgående
arbejde med at få tilkoblet en USB-WIFI-adapter til AR.Dronen, har dog
vist, at det generelt er muligt at udvide AR.Dronen med USB-enheder.
...
En detaljeret vurdering gives i
...
den opdaterede AR.Drone version 2.0).  Det vurderes desuden at
...
flydende afvikling ikke længere var mulig. Begrænsningen har dog
også medført et fokus på at skrive mere effektiv kode, især i forbindelse
med udviklingen af taskssystemet. For at kombinere hastigheden fra
sprog som C og C++ med udviklingshastigheden og letlæseligheden fra
Python, kunne det være have været en mulighed at implementere et eller
...
platform, var det en mulighed at have anvendt ROS (Robot Operating
System),~\cite{wiki:ros}. ROS er et mere generelt framework til
robotudvikling og har en driver udviklet til
AR.Dronen,~\cite{brown:ros}.

\subsection{OpenCV}
Anvendelsen af OpenCVs billedbehandlingsalgoritmer har været en
nødvendighed, algoritmerne ville givetvis have været alt for langsomme
implementeret i Python. Anvendelsen af OpenCVs Python interface har
været simpel, på trods af enkelte forklaringsproblemer i
dokumentationen. 
...
Efter de lovende resultater med korridordetektoren, kunne denne
